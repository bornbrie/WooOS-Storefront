<?php
 /**
  * WooOS REST API for WooCommerce
  *
 ...
 class Woo_OS_Rest_API {
 	 ...
 	 * @version 1.0.3
 	 */
 	public function woo_os_rest_api_init() {
 	...
 	private function include_products_controller() {
 		...
 		include_once( dirname( __FILE__ ) . '/class-woo-os-products-rest-controller.php' );
 	} // include()
 	...
 	public function register_products_routes() {
 		$controller = new Woo_OS_Products_REST_Controller();
